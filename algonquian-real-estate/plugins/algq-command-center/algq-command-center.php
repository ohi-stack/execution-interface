...
final class ALGQ_Command_Center
{
    ...
    private function render_command_center(bool $expanded): string
    {
        ...
        <section class="algq-command-center" aria-label="<?php esc_attr_e('Algonquian Command Center', 'algq-command-center'); ?>">
            ...
            <?php if (shortcode_exists('algq_revenue_dashboard')) : ?>
                <div class="algq-command-revenue-panel">
                    <?php echo do_shortcode('[algq_revenue_dashboard]'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </div>
            <?php endif; ?>
