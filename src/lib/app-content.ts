export const appHomeHero = {
  ...
  title: 'OneGodian App',
  description:
    'Your unified OneGodian dashboard for membership, certificates, campaigns, media, products, learning, tools, and ecosystem access.',
  primaryCta: {
...
export const appFooterBoundary =
  'OneGodian App is the public and member-facing dashboard. Internal operations, deployment tools, plugin management, and system administration are handled through OneGodian Console.';
