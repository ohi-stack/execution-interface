...
export const appModules: AppModule[] = [
  ...
  { title: 'Tools', shortTitle: 'Tools', slug: 'tools', route: '/tools', category: 'Utilities', productionStatus: 'In Development', priority: 'High', visibility: 'public', iconKey: 'wrench', odinCode: 'ODN-UTL-009', domain: 'tools.onegodian.com', repo: BASE_REPO, deploymentTarget: 'Vercel Preview', version: 'v0.7.5', connectedSystemIds: ['dashboard', 'time', 'capital', 'offer-generator'], features: ['Tool launcher', 'Utility cards', 'Offer generator access'], checklist: ['Core set ready', 'Permissions pending'], nextActions: ['Add execution history'], metrics: [{ label: 'Active Tools', value: '28', trend: 'up' }] },
  { title: 'Offer Generator', shortTitle: 'Offers', slug: 'offer-generator', route: '/offer-generator', category: 'Utilities', productionStatus: 'Demo Ready', priority: 'High', visibility: 'internal', iconKey: 'file-signature', odinCode: 'ODN-UTL-016', domain: 'tools.onegodian.com', repo: BASE_REPO, deploymentTarget: 'Vercel Preview', version: 'v0.1.0', connectedSystemIds: ['tools', 'capital', 'products'], features: ['Purchase Agreement templates', 'LOI generator', 'Seller-financing offers', 'PDF generation', 'Version history', 'Deal merge fields'], checklist: ['Template catalog seeded', 'Merge fields mapped', 'PDF export scope defined'], nextActions: ['Connect generated documents to deal records', 'Add reviewer approval states'], metrics: [{ label: 'Template Families', value: '3', trend: 'up' }, { label: 'Merge Fields', value: '12', trend: 'up' }] },
