...
export const ecosystemProperties: PropertyCard[] = [
  ...
  { key: 'app', title: 'OneGodian App', role: 'Public/member-facing app gateway', domain: 'app.onegodian.com', href: 'https://app.onegodian.com', status: 'Operational', health: 'Core pages and APIs online', description: 'Member dashboard linking public OneGodian properties without operator controls.', checklist: ['Core routes built', 'Member routes mapped', 'Production checklist published'], adminHref: '/dashboard' },
  { key: 'acc', title: 'ACC™ / Control Plane', role: 'Internal operations and workflow command system', domain: 'console.onegodian.com', href: 'https://console.onegodian.com', status: 'Needs Setup', health: 'Console-only deployment boundary documented', description: 'Operator-only ACC™, OCP, OEG, approvals, audit, adapters, and deployment controls.', checklist: ['Keep out of public ecosystem pages', 'Deploy from the control-panel repository', 'Restrict to authorized internal users'], adminHref: '/admin' }
];
