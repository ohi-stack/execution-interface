...
export const systemHierarchy: SystemHierarchyLayer[] = [
  ...
  { level: 'Level 4', title: 'Systems Layer', emoji: '⚙️', status: 'In Development', description: 'Core runtime systems including intelligence, alignment, execution, blockchain, timekeeping, and agent command infrastructure.', examples: ['OHI', 'Quantum-OHI', 'OMOS', 'OBP-1', 'OTS-V5'] },
